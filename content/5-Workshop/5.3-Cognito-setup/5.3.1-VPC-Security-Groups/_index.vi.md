...
{{< blog-image src="images/5-Workshop/5.3-Network-RDS/5.3.1-step1-create-vpc.png" alt="Thông tin VPC của Startups Blogs" caption="Hình 1. Startups-Blogs-vpc ở trạng thái Available với IPv4 CIDR 10.0.0.0/16." >}}
...
{{< blog-image src="images/5-Workshop/5.3-Network-RDS/5.3.1-step2-subnets.png" alt="Public subnet và private subnet của Startups Blogs" caption="Hình 2. Các public subnet và private subnet trong VPC của dự án." >}}
...
{{< blog-image src="images/5-Workshop/5.3-Network-RDS/5.3.1-step3-igw.png" alt="Internet Gateway gắn với VPC Startups Blogs" caption="Hình 3. Startups-Blogs-igw đã được gắn vào VPC của dự án." >}}
...
{{< blog-image src="images/5-Workshop/5.3-Network-RDS/5.3.1-step4-ec2-sg.png" alt="Inbound rule của EC2 Security Group" caption="Hình 4. Inbound rule SSH và cổng ứng dụng NestJS trong EC2-Security-Group." >}}
...
{{< blog-image src="images/5-Workshop/5.3-Network-RDS/5.3.1-step5-rds-sg.png" alt="Inbound rule PostgreSQL của RDS Security Group" caption="Hình 5. Các rule PostgreSQL port 5432 trong RDS-Security-Group." >}}
