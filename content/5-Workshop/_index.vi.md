...
3. [Cấu hình Hạ tầng AWS](5.3-Cognito-setup/)
4. [Cấu hình Amazon Cognito](5.4-Cognito-configuration/)
5. [Tích hợp Backend NestJS, REST APIs & HttpOnly Cookie Session](5.4-Backend-integration/)
6. [Tích hợp Frontend React 19, Zustand State & Admin Dashboard](5.5-Frontend-integration/)
7. [Tự động hóa Hạ tầng bằng Terraform & Giám sát CloudWatch](5.6-Security-review/)
8. [Dọn dẹp tài nguyên & Tổng kết](5.7-Cleanup/)
